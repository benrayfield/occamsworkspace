...
public class MnistOcrDataset{
	...
	public static byte[][][] readTrainingImages(){
		...
		byte[] gz = Files.readFileOrInternalRel("/data/datasets/mnistOcr/train-images-idx3-ubyte.gz");
		return readImages(ByteStreams.bytes(ungzipping(gz)));
	}
	
	public static byte[][][] readTestImages(){
		byte[] gz = Files.readFileOrInternalRel("/data/datasets/mnistOcr/t10k-images-idx3-ubyte.gz");
	...
	public static byte[] readTrainingLabels(){
		...
		byte[] gz = Files.readFileOrInternalRel("/data/datasets/mnistOcr/train-labels-idx1-ubyte.gz");
	...
	public static byte[] readTestLabels(){
		...
		byte[] gz = Files.readFileOrInternalRel("/data/datasets/mnistOcr/t10k-labels-idx1-ubyte.gz");
		return readLabels(ByteStreams.bytes(ungzipping(gz)));
	}
