...
*/
public class LearnLoop implements Runnable{
	...
	*/
	public void run(){
		throw new Error("TODO override this");
	}
	...
	*/
	...
	/** Any line that starts with === is a key, and whatever follows is value (trimmed)
	until next key or end of script.
	Example: ===PER=NEW=RBM=== and ===PER=BATCH=== and ===PER=WEIGHT===
	*/
	public static NavigableMap<String,String> parseLearnloopScript(String script){
		...
		try{
			while((line = br.readLine()) != null){
				...
				if(isKey){
					...
					value += Text.n+line.trim();
				}
			}
			if(key != null) map.put(key, value.trim());
		}catch(IOException e){
			throw new Error(e);
		}
	...
	public static void main(String[] args) {
		System.out.println(parseLearnloopScript("===abc===\r\ndef\r\nghi\r\n\r\n===zzz===\r\nZZZ"));
	}
