package mutable.listweb.todoKeepOnlyWhatUsingIn.humanaicore.wavetree.bit;
...
public class TestUseLotsOfMemory{
	...
	public static void main(String[] args){
		...
		randBitsInAsBalancedATreeAsPossible(unbalancedAndRandomSplitSize, size, new Random());
		gcAndPrint();
	}
