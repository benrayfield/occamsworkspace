...
/** paint video 1 frame at a time as a Zing. Can paint magified using Graphics.fillRectangle or per pixel as BufferedImage.
...
*/
public class ZingVideoAftrans extends JPanel{
	...
	*/
	...
	public static void testDisplay(ZingVideoAftrans z){
	...
	public static void main(String[] args){
		JFrame window = new JFrame("test "+ZingVideoAftrans.class.getName());
		ZingVideoAftrans z = new ZingVideoAftrans();
		window.add(z);
