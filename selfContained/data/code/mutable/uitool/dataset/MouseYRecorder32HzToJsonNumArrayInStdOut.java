...
*/
public class MouseYRecorder32HzToJsonNumArrayInStdOut extends Uitool{
	...
	*/
	...
	public MouseYRecorder32HzToJsonNumArrayInStdOut(){
		MouseYRecorder32HzToJsonNumArrayInStdOut ths = this;
		...
		addMouseListener(new MouseListener() {
			public void mouseClicked(MouseEvent e) {
				...
				for(int i=0; i<ths.mouseFractions[0].size(); i++){
					if(i != 0) sb.append(", ");
					sb.append(ths.mouseFractions[0].get(i));;
				}
				sb.append("]");
				lg("MouseYRecorder32HzToJsonNumArrayInStdOut: "+sb);
			}
	...
	public void paint(Graphics g){
		...
		g.drawString("Click to stdOut [...mouseY...] json", 50, 50);
	}
	...
	public static void main(String[] args){
		ScreenUtil.testDisplayWithExitOnClose(new MouseYRecorder32HzToJsonNumArrayInStdOut());
	}
